...
in
{
  ...
  programs.git = {
    ...
    # wrong [user] still wins over both this file and the included one. The
    # backstop for that case is sync-forks' assert_identity, which fails the
    # repo and fires the failure notification instead of letting the wrong
    # identity pass silently. The included file is generated by the fleet
    # tooling and contains identity only.
    includes = [
      {
